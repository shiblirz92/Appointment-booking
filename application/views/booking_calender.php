...
<div style="margin-top:10rem" class="main-slider">
   <div class="slider-content parallax position-relative overflow-hidden back-mountent h-100">
      <div class="slider-top-banner">
         <div class="container">
             <form action="<?php echo base_url() ?>booking/confirmBooking" method="post" enctype="fortm-data/multipart">
            ...
            <br>
                ...
                <div style="flex:1 20%">
                    ...
                    <label for="">Choose Appointment Date</label><br>
                        <input style="width:18rem;padding:1rem" name="booking_date" style="text-align:right;" type="text" value="<?php echo date('d-m-y') ?>" id="date" readonly disabled>
                    </div>
                </div> -->
...
<!-- <?php 
    ...
    $doctor_id="<script>document.writeln(res);</script>";


 $query=$this->db->query('select GROUP_CONCAT(booked_date) as disable from booked_dates where number_of_bookings="20"');
 $result=$query->row();
