   ...
   <div class="container">
      <div class="iq-navbar-custom">
         <div class="d-flex align-items-center justify-content-between">
            ...
            <h3 style="font-size:0.8rem">  <img src="<?php echo base_url() ?>assets/images/logo.png" class="img-fluid rounded-normal light-logo" alt="Apex Hospital">Apex Hospital</h3> 
               <img src="<?php echo base_url() ?>assets/images/logo.png" class="img-fluid rounded-normal darkmode-logo d-none" alt="logo">
               </a>
            </div>
